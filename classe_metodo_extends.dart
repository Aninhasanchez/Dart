...
//Criando uma segunda classe que herda atributos e metodos da primeira
...
//Chamando as classes Data e DataHora
main(){


  //instanciando a classe Data
  Data dataAtivacao = Data();

  dataAtivacao.dia = 10;
  dataAtivacao.mes = 4;
  dataAtivacao.ano = 2025;

  //Instanciando a classe DataHora
  DataHora dataHoraLeitura = DataHora();

  dataHoraLeitura.dia = 22;
  dataHoraLeitura.mes = 5;
  dataHoraLeitura.ano = 2025;
  dataHoraLeitura.hora = 14;
  dataHoraLeitura.minuto = 30;
  dataHoraLeitura.segundo = 45;

  //Exibindo os resultados
  String d1 = dataAtivacao.obterDataFormatadaComString();
  String d2 = dataHoraLeitura.obterDataFormatadaComString();
